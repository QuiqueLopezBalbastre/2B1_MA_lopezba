...
int main()
{
	...
	volatile unsigned int* video_regs = (volatile unsigned int*) 0x4000000; // mode3, bg2 on (16 bits RGB)
  ...
  while(1) {
    ...
    Paint ((unsigned short*) Screen + x + y * SCREEN_W, Ball, SCREEN_W, RGB16(r >> 5,g >> 5,b >> 5));
